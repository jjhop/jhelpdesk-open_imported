...
<div id="hint">
<div id="hinttop"></div>
<div id="hintmiddle">Polski kierowca przejechał 98 okrążeń, a jego najlepszy czas to 1.31,751 min. Kolega Polaka z zespołu Nick Heidfeld był 10. (1:31.720). Najlepszy Felipe Massa z Ferrari był o 1,8 s szybszy od Kubicy. Zimowe testy BMW Sauber można podzielić na trzy okresy. Najpierw kierowcy rozpoznawali nowe dla zespołu opony bridgestone.</div>
