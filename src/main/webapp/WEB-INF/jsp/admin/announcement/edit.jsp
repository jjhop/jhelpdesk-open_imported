...
<div id="editannouncement" class="management">
    ...
    <table cellspacing="0">
        <tr>
            <td class="rightcells">
                <div class="pagecontentsubheader"><h3 id="headAdminAnnoucementEdit">Edycja wiadomości</h3></div>
                <div id="content">
                    ...
                    <div class="contentmiddle">
                        ...
                        <form:form commandName="announcement" action="${formUrl}" method="post">
                            ...
                            <a href="<c:url value="/announcements/list.html"/>" class="btnPlain btnMarginTop">anuluj</a>
                        </form:form>
                    </div>
