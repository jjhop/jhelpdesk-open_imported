    ...
    <div id="content">
        ...
        <div class="contentmiddle">
            ...
            <display:column title="Przyczyna zgłoszenia" class="bugsDetail" headerClass="bugsDetail">
                <a href="<c:url value="bugDetails.html"/>?bugId=<c:out value="${bugsIterator.bugId}"/>" onmouseover="jShowDesc(event, 'row_<c:out value="${bugsIterator.bugId}"/>');" onmouseout="jHideDesc(event, 'row_<c:out value="${bugsIterator.bugId}"/>');" title=""><c:out value="${bugsIterator.subject}"/></a>
            ...
            <display:column title="" media="html" class="bugView" headerClass="bugView">
                <a href="<c:url value="bugDetails.html"/>?bugId=<c:out value="${bugsIterator.bugId}"/>">View</a>
            </display:column>

            <%--
                <display:column title="" media="html" class="bugDrop" headerClass="bugDrop">
                <a href="<c:url value="editBug.html"/>?bugId=<c:out value="${bugsIterator.bugId}"/>">Drop</a>
                </display:column>
            --%>
