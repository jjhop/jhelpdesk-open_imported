            ...
            <td class="rightcells">
                ...
                <div id="content">
                    ...
                    <div class="contentmiddle">
                        <table cellspacing="0" class="standardtable">
                            ...
                            <tr class="options">
                                <td style="width: 186px;">
                                    <input id="t1" type="radio" name="x"/><span><label for="t1">Temat pierwszy</label></span><br />
                                    <div><img src="http://www.gram.pl/www_image.asp?ip=upl/galerie/425/1.jpg&fn=g" width="150" height="100" alt="d"/></div>
                                </td>
                                <td style="width: 186px;">
                                    <input id="t2" type="radio" name="x"/><span><label for="t2">Temat drugi</label></span><br />
                                ...
                                <td class="lastcol" style="width: 188px;">
                                    <input id="t3" type="radio" name="x"/><span><label for="t3">Temat trzeci</label></span><br />
                        ...
                        <table cellspacing="0" class="standardtable">
                            <tr>
                                <th colspan="5" class="lastcol">Strona startowa (zgłoszenia podać z aktualmych filtrów)</th>
                            </tr>
                            <tr class="options">
                                <td style="width: 111px;"><input type="radio" name="x"/><span>biurko</span></td>
                                <td style="width: 111px;"><input type="radio" name="x"/><span>zgłoszenia</span></td>
                                <td style="width: 111px;"><input type="radio" name="x"/><span>nowe zgłoszenie</span></td>
