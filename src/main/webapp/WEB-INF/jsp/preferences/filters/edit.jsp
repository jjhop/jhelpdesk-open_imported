                ...
                <tbody><tr class="top">
                    ...
                    <tr class="middle">
                        <td id="middlecenter">
                            ...
                            <table id="table2">
                                <tr><td class="w100 p20l">Nazwa*:</td><td><form:input path="name" cssClass="w250"/><font color="red"><form:errors path="name" /></font></td></tr>
                                <tr><td class="p20l">Opis:</td><td><form:textarea path="description" cssClass="w250"/></td></tr>
                                <tr><td class="p20l">Od:</td><td><form:input path="beginDate" cssClass="w250" /></td></tr>
                                <tr><td class="p20l">Do:</td><td><form:input path="endDate" cssClass="w250" /></td></tr>
                                <tr><td class="p20l">Kategoria:</td>
                                    <td>
