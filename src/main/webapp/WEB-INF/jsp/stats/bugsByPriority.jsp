...
BugStatsByPriorityDatasetProducer currentMonth = ( BugStatsByPriorityDatasetProducer ) request.getAttribute( "currentMonth" );
BugStatsByPriorityDatasetProducer threeMonth = ( BugStatsByPriorityDatasetProducer ) request.getAttribute( "threeMonth" );
BugStatsByPriorityDatasetProducer allTime = ( BugStatsByPriorityDatasetProducer ) request.getAttribute( "allTime" );
%>
