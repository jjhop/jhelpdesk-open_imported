...
<jsp:useBean id="pageViews1" class="de.berlios.jhelpdesk.web.charts.TicketStatsByNotyfier1DatasetProducer" scope="request"/>
<jsp:useBean id="pageViews2" class="de.berlios.jhelpdesk.web.charts.TicketStatsByNotyfier2DatasetProducer" scope="request"/>
