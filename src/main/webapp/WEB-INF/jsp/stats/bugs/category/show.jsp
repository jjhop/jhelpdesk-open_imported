...
<div id="stats">
	...
	<div class="chartcontainer">
		<div class="chartbox">
			...
			<tiles:insert page="/WEB-INF/jsp/stats/bugs/category/currentWeek/show.jsp" flush="true" />
		</div>
		<div class="chartbox">
			<div id="pagecontentsubheader"><h3>Zgłoszenia w/g kategorii - bieżący miesiąc</h3></div>
			<tiles:insert page="/WEB-INF/jsp/stats/bugs/category/currentMonth/show.jsp" flush="true" />
		</div>
		<div class="chartbox">
			<div id="pagecontentsubheader"><h3>Zgłoszenia w/g kategorii - poprzednie 3 m-ce</h3></div>
			<tiles:insert page="/WEB-INF/jsp/stats/bugs/category/prevThreeMonths/show.jsp" flush="true" />
		</div>
		<div class="chartbox">
			<div id="pagecontentsubheader"><h3>Zgłoszenia w/g kategorii - wszystkie</h3></div>
			<tiles:insert page="/WEB-INF/jsp/stats/bugs/category/all/show.jsp" flush="true" />
		</div>
	</div>
</div>
