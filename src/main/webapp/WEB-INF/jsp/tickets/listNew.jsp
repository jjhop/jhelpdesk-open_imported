...
<div id="newtickets" class="ticketslist">
    <div id="pagecontentheader">
        <h2>Zgłoszenia</h2>
    </div>
    <div id="pagecontentsubheader">
        <h3>Lista nowych zgłoszeń</h3>
    </div>
    <div id="content">
        ...
        <div class="contentmiddle">
            ...
            <display:column title="Przyczyna zgłoszenia" class="ticketsDetail" headerClass="ticketsDetail">
                <a href="<c:url value="ticketDetails.html"/>?ticketId=<c:out value="${ticketsIterator.ticketId}"/>" onmouseover="jShowDesc(event, 'row_<c:out value="${ticketsIterator.ticketId}"/>');" onmouseout="jHideDesc(event, 'row_<c:out value="${ticketsIterator.ticketId}"/>');" title=""><c:out value="${ticketsIterator.subject}"/></a>
            ...
            <display:column title="Data" sortable="true" class="createDate" headerClass="createDate">
            ...
            <display:column property="inputer" title="Zgłaszający" class="notifier" headerClass="notifier" sortable="true" />
            <display:column title="" media="html" class="ticketView" headerClass="ticketView">
                <a href="<c:url value="ticketDetails.html"/>?ticketId=<c:out value="${ticketsIterator.ticketId}"/>">View</a>
            </display:column>

            <%--
                <display:column title="" media="html" class="ticketDrop" headerClass="ticketDrop">
                <a href="<c:url value="editTicket.html"/>?ticketId=<c:out value="${ticketsIterator.ticketId}"/>">Drop</a>
                </display:column>
            --%>
