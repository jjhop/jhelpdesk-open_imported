...
public class TicketStatsByCategoryDatasetProducer implements DatasetProducer, PieToolTipGenerator,
	...
	private static final Log log = LogFactory.getLog(TicketStatsByCategoryDatasetProducer.class);
	// private final static String[] seriesNames = {"cewolfset.jsp", "tutorial.jsp", "testpage.jsp",
	// "performancetest.jsp"};

	private final Map<String, Long> chartData;

	public TicketStatsByCategoryDatasetProducer(Map<String, Long> chartData) {
		log.debug("");
	...
	public String getProducerId() {
		return "TicketStatsByCategoryDatasetProducer DatasetProducer";
	}
	...
	public String generateLink(Object dataset, Object category) {
		return "showTicketsByCategory.html?categoryId=" + category.toString();
	}
